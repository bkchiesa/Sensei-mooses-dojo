...
export const BOSSES: FighterDef[] = [
  ...
  boss("finley", "Finley", rgb(0.45, 0.55, 0.25), "mariners", "Vertical Suplex", "Vertical snap-suplex.", "suplex"),
  ...
  boss("kasey", "Kasey", rgb(0.65, 0.25, 0.4), "jrbridge", "Moonsault Splash", "Backflip moonsault splash.", "moonsault"),
  boss("jaylen", "Jaylen", rgb(0.2, 0.55, 0.55), "colonial", "Hurricane Kick", "Spinning hurricane kick barrage.", "tornadoKick"),
